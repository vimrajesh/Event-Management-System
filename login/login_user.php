...
$result = mysqli_query($con,"SELECT * FROM user_authentication WHERE UserId='" . $username . "' AND Password = '$hash'");
...
if(is_array($row)) {
	...
	$timestamp = mysqli_query($con,"UPDATE user SET Last_Login_Info = CURRENT_TIMESTAMP()  WHERE UserId='" . $row['UserId'] ."'");
} 
else {
