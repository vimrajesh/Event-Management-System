...
<?php
    ...
    if(isset($_POST['delete']))
    {
        ...
        if(mysqli_connect_errno($conn))
        {
            ...
            $result3=mysqli_query($conn,"DELETE FROM review WHERE event_id = '$id'") or die("Error4: " . mysqli_error($conn));
...
<div class="topnav" id="myTopnav">
  ...
  <?php
    ...
    <h2 style="color:green;">Delete an Event</h2>
        <form enctype="multipart/form-data" action="delete_event.php" method="post">
            <tr>
                <td>
                    Event Name :
                </td>
                <td>
                    ...
                    <?php 
                        $conn=mysqli_connect('localhost','root','','event_management_nitc'); 
                        $result=mysqli_query($conn,'SELECT Event_Id,Event_Name FROM events ORDER BY Event_Id'); 
